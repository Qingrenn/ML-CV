...
3. 最后根据特征值的大小，从n个特征值中选取前k个较大特征值所对应的k个特征向量构成特征向量矩阵（转移矩阵P(n*k)），将样本数据（A(n,1)）转换到新的空间下[p1](https://latex.codecogs.com/gif.latex?\\A' = P^{T}A)。
...
>>>>>>> c0a97e041ade67fbc136604f70417945ea430a42
